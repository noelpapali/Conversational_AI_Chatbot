...
main_page_url = config.get('DEFAULT', 'main_page_url', fallback="https://execed.utdallas.edu/")
...
# Output file path
output_file = os.path.join(output_dir, "exec_ed_data.txt")
...
def extract_menu_links(soup, base_url):
    ...
    menu_links = []
    menu_container = soup.find("div", class_="menu-main-menu-container")
    if menu_container:
        ...
        logging.warning("Main menu container not found.")
    return menu_links
